...
class Test {
    public static void main(String[] args) {
        ...
        Multiply one = new Multiply(new Variable('x'), new Variable('x'));
        Multiply two = new Multiply(new Const(2), new Variable('x'));
        Subtract three = new Subtract(one, two);
        Add expression = new Add(three, new Const(1));
