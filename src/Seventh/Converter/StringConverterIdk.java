...
class MovableRectangle implements Movable {
  ...
  public MovableRectangle(double upperX, double upperY, double lowerX, double lowerY, double upperSpeed,
      double lowerSpeed) {
    this.lowerX = lowerX;
    this.lowerY = lowerY;
    this.upperX = upperX;
  ...
  public String toString() {
    String res = "Upper: " + this.upperX + " " + this.upperY + " " + this.upperSpeed + "\n" + "Lower " + this.lowerX
        + " " + this.lowerY + " " + this.lowerSpeed;
    return res;
  }
